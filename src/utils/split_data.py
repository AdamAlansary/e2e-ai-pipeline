...
image_paths = np.array(list(map(lambda x: os.path.join(cfg.BASE_DATASET_PATH, x), df['images'].values)))
mask_paths = np.array(list(map(lambda x: os.path.join(cfg.BASE_DATASET_PATH, x), df['masks'].values)))
